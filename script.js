...
document.getElementById("btn-enter-created").onclick = () => {
  ROOM = document.getElementById("create-room").value;
  if (!ROOM) return alert("合言葉を入力してね");
  startChat();
};

document.getElementById("btn-enter-joined").onclick = () => {
...
function startChat() {
  show("chat-screen");
  document.getElementById("room-title").textContent = "部屋名: " + ROOM;
